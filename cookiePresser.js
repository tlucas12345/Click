...
Game.AchievementsById[145].name="Megatap"
Game.AchievementsById[145].desc="Make 10,000,000,000,000 cookies pressing the spacebar.";
Game.AchievementsById[145].baseDesc="Make 10,000,000,000,000 cookies pressing the spacebar.";
Game.AchievementsById[146].name="Supertap"
...
Game.AchievementsById[147].name="Ultratap"
Game.AchievementsById[147].desc="Make 1,000,000,000,000,000 cookies pressing the spacebar.";
Game.AchievementsById[147].baseDesc="Make 1,000,000,000,000,000 cookies pressing the spacebar.";
Game.AchievementsById[148].name="Extratap"
Game.AchievementsById[148].desc="Make 100,000,000,000,000,000 cookies pressing the spacebar.";
Game.AchievementsById[148].baseDesc="Make 100,000,000,000,000,000 cookies pressing the spacebar.";
Game.AchievementsById[149].name="Gigatap"
Game.AchievementsById[149].desc="Make 10,000,000,000,000,000,000 cookies pressing the spacebar.";
Game.AchievementsById[149].baseDesc="Make 10,000,000,000,000,000,000 cookies pressing the spacebar.";
Game.AchievementsById[150].name="Metatap"
Game.AchievementsById[150].desc="I'll be surprised if you didn't notice these BIT . TRIP references.";
Game.AchievementsById[150].baseDesc="I'll be surprised if you didn't notice these BIT . TRIP references.";
